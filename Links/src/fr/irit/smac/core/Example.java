...
public class Example {
	...
	public static void main(String[] args) {
		...
		int i = 0;
		// s2.addEntity(""+i, "Test");
		DrawableAttribute datt = new DrawableAttribute(Type.ENTITY, "0", "DrawRanger",
				new DoubleAttribute("DoubleDraw : ", 75));
		s2.addEntity("0", "Bip");
		...
		while (continu) {
			...
			/*
			 * if(i == 10){ DrawableAttribute datt1 = new
			 * DrawableAttribute(Type.ENTITY,"TestDraw","DrawRanger",new
			 * DoubleAttribute("DoubleDraw : ", 75)); }
			 */
